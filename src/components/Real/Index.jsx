  ...
  return (
    ...
    >
        ...
        >
            {/* 1st slide */}
            <div 
                className="slide w-full sm:flex items-center 
            ...
            >
                ...
                <div 
                    className="image absolute w-[25vh] h-[25vh] sm:w-[45vh] sm:h-[45vh] -translate-y-2/5
            ...
            >
                ...
                <div className='w-[60%] text-center font-[SansitaReg] relative'>
                    <h3 
                        ...
                        tracking-tight text-[2.2vh] sm:absolute top-0 left-0 z-[3] 
                ...
                <div 
                    className="image absolute w-[15vh] sm:w-[20vh] sm:h-[20vh] top-4/5
                ...
                <div 
                    className="image absolute w-[20vh] sm:w-[45vh] sm:h-[45vh] first-letter: sm:bottom-0 right-1/6 
                    translate-y-[20vh]"
                >
                    <img 
                        src={img3}
