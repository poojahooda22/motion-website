  ...
  return (
    <div className="para2 section w-full flex items-center justify-center -translate-y-1/5 ">
        <div className="text w-[80%] flex flex-col items-end justify-center ">
            ...
            <h3 className='textpara2 w-[40%] font-[Sansita] text-2xl font-medium text-center leading-[2.4rem] mb-10'> Working with Significo and their recommendation service has been a game-changer for our occupational prevention efforts. Our customers are extremely satisfied with the tool&apos;s impressive technical capabilities and data-driven approach. But what truly sets it apart is the intuitive and modern user experience it offers, making it a breeze for our clients to navigate. By leveraging this service, our customers have successfully tackled presenteeism and absenteeism, making a significant impact on their workforce&apos;s well-being. We highly recommend Significo to any organization looking to optimize their occupational health and drive positive change.
            </h3>
